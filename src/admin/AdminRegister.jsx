      ...
      <div className="admin-register-card">
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.75rem' }}>
          <div className="input-group">
            <label>Full Handle</label>
            <div style={{ position: 'relative' }}>
              <User size={20} style={{ position: 'absolute', left: '1.25rem', top: '50%', transform: 'translateY(-50%)', color: 'rgba(255,255,255,0.2)' }} />
              <input
                type="text"
          ...
          >
            {loading ? (
              ...
              <><ShieldPlus size={20} strokeWidth={2.5} /><span>Enroll Account</span><ArrowRight size={20} strokeWidth={2.5} /></>
            )}
          </button>
        </form>
        ...
        <div style={{ marginTop: '3.5rem', textAlign: 'center', borderTop: '1px solid rgba(255,255,255,0.08)', paddingTop: '2.5rem' }}>
          <p style={{ color: 'rgba(255,255,255,0.4)', fontSize: '0.9rem', fontWeight: 500 }}>
            Already Enrolled? {' '}
            <Link to="/admin/login" style={{ color: '#fff', fontWeight: 800, textDecoration: 'none', borderBottom: '1px solid rgba(255,255,255,0.2)' }}>Portal Login</Link>
          </p>
        </div>
      </div>
